...
// OVERLAY
gsap.to(".primeiro", 1.5, {delay: .5, top: "-100%", ease: Expo.easeInOut});
gsap.to(".segundo", 1.5, {delay: .7, top: "-100%", ease: Expo.easeInOut});
gsap.to(".terceiro", 1.5, {delay: .9, top: "-100%", ease: Expo.easeInOut});
